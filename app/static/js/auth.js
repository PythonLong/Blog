var Auth = {
	vars: {
		...
		password_hidden:document.querySelector('.indent'),
        ...
        remember_div: document.querySelector('.remember'),
		option: {}
	},
	register(e) {
	...
	forgot(e) {
		...
		//隐藏掉密码,记住 框
		Auth.vars.password_hidden.setAttribute("type","hidden");
		Auth.vars.remember_div.setAttribute("style",'display:none');
	...
	loginback(e) {
		...
		//显示出密码框
		Auth.vars.password_hidden.setAttribute("type","password");
		...
		setTimeout(() => {
			Auth.vars.remember_div.removeAttribute("style");
		}, 1500);
